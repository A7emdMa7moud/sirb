      ...
      {/* <section className="w-full bg-primary pt-28 pb-12 px-4 md:px-0 flex flex-col items-center text-white text-right">
        ...
        <div className="max-w-2xl text-lg leading-8 mb-6 text-gray-200 text-center mx-auto">
          <p>
            ...
            العربي والعالمي! في سيرب، نقدم لك منصة متكاملة تتيح لك استكشاف أحدث
            وأشهر الأفلام والمسلسلات من مختلف التصنيفات والأنواع. مع سيرب، ستجد
            مكتبة ضخمة من الأعمال السينمائية والتلفزيونية، مع تقييمات دقيقة
            وترشيحات مخصصة تناسب ذوقك وتلبي اهتماماتك.
          </p>
          <p className="mt-4">
          ...
          <p className="mt-4">
            على سيرب، نؤمن بأن الترفيه لا يجب أن يكون معقدًا. لذلك صممنا منصتنا
            لتكون سريعة، سهلة، ومليئة بالمحتوى الرائع الذي يهمك. من خلال تقييمات
            دقيقة وترشيحات محدثة باستمرار، ستجد دائمًا الجديد لتشاهد وتستمتع به.
            سواء كنت من عشاق مشاهدة الأفلام أو متابعة أحدث المسلسلات العربية
            والعالمية، سيرب هو خيارك الأمثل.
          </p>
          <p className="mt-4">
            سيرب يدعم اللغة العربية بالكامل ويوفر تجربة تصفح متوافقة مع جميع
            الأجهزة. انضم إلى سيرب اليوم وابدأ رحلتك في عالم مشاهدة الأفلام
            والمسلسلات العربية والعالمية، وتمتع بتجربة فريدة مليئة بالتقييمات
            والترشيحات المميزة.
          </p>
        </div>
